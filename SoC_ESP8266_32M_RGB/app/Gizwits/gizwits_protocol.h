...
* @{
*/
#define PRODUCT_KEY "75c306a3464149918e1eb09c1f752c51"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "79bda4efb84943729b2f232af935a505"
...
* @{
*/
#define RGB_PWR_BYTEOFFSET                    0
#define RGB_PWR_BITOFFSET                     0
#define RGB_PWR_LEN                           1
#define RGB_Color_BYTEOFFSET                    0
#define RGB_Color_BITOFFSET                     1
#define RGB_Color_LEN                           1

#define RGB_R_RATIO                         1
#define RGB_R_ADDITION                      0
#define RGB_R_MIN                           0
#define RGB_R_MAX                           254
#define RGB_G_RATIO                         1
#define RGB_G_ADDITION                      0
#define RGB_G_MIN                           0
#define RGB_G_MAX                           254
#define RGB_B_RATIO                         1
#define RGB_B_ADDITION                      0
#define RGB_B_MIN                           0
#define RGB_B_MAX                           254
/**@} */
...
typedef enum
{
    RGB_Color_VALUE0 = 0,//红，1.绿，2.蓝，3.其他
    RGB_Color_VALUE_MAX,
} RGB_Color_ENUM_T;
...
typedef struct {
  uint8_t flagRGB_PWR:1;
  uint8_t flagRGB_Color:1;
  uint8_t flagRGB_R:1;
  uint8_t flagRGB_G:1;
  uint8_t flagRGB_B:1;
} attrFlags_t;
